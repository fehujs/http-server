...
import { ExtractBodyInterface, Form, RequestBody, RequestFiles, RouteParams } from "../types"
...
export class Request {
    ...
    private static async extractPostRequestData(form: Form, req: IncomingMessage): Promise<ExtractBodyInterface> {
        return new Promise(async (resolve, reject) => {
            ...
            if (!form.incomingForm) {
                reject(`[request parsing] error: incompatible form: 'form.incomingForm' is undefined.`)
                return
            }
